...
<div class="row">
 ...
 <div class="btn-group">
   ...
   <?php } ?>
   <?php if(!in_array($invoice->status, array(2,5,6)) && has_permission('invoices','','edit') && get_option('cron_send_invoice_overdue_reminder') == 1){ ?>
    <li>
...
<?php echo form_close(); ?>
<hr />
<div class="panel_s mtop20" id="sales_notes_area">
</div>
</div>
