          ...
          <div class="panel-body _buttons">
            <div class="row">
             ...
             <div class="col-md-4 text-right">
              ...
              <a href="#" onclick="<?php echo $invoice_func; ?>(<?php echo $project->id; ?>); return false;" class="invoice-project btn btn-success<?php if($project->client_data->active == 0){echo ' disabled';} ?>"><?php echo _l('invoice_project'); ?></a>
              <?php } ?>
              <?php
